...
$LANG["NEW_VERSION_OF_TT_NOW_AVAIL"] = "NEW Version of M-BiTsy now available";
$LANG["NEWS"] = "News";
...
$LANG["YOU_HAVE_LATEST_VER_INSTALLED"] = "You have the latest Version of M-BiTsy Installed:";
...
$LANG["FORUM_RULES2"] = "Please do try not to discuss upload/release-specific stuff here, post a torrent comment instead!<br /><br /><b>Please make sure to read the <a href='" . URLROOT . "/rule'>rules</a> before you post</b>";

$LANG["FORUMS_DEL_POST"] = "Delete post";
$LANG["FORUMS_DEL_POST_ONLY_POST"] = "Can't delete post; it is the only post of the topic. You should <a href='" . URLROOT . "/topic/delete?topicid=%s&amp;sure=1'>delete the topic</a> instead.\n";
$LANG["FORUMS_DEL_POST_SANITY_CHK"] = "Sanity check: You are about to delete a post. Click <a href='" . URLROOT . "/post/delete?postid=%s&amp;sure=1'>here</a> if you are sure.";
$LANG["FORUMS_DEL_TOPIC"] = "Delete topic";
$LANG["FORUMS_DEL_TOPIC_SANITY_CHK"] = "Sanity check: You are about to delete a topic. Click <a href='" . URLROOT . "/topic/delete?topicid=%s&amp;sure=1'>here</a> if you are sure.";
...
$LANG["POWERED_BY_TT"] = "Powered by M-BiTsy %s";
