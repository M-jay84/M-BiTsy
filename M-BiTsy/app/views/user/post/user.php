   ...
   <div class="container">
      <div class="row ttborder">
         ...
         <div class="col-10">
            ...
            <p class="float-end"><?php echo $user['edit'] . $user['delete']  ?><a href="<?php echo URLROOT ?>/report/forum?forumid=<?php echo $row['topicid']  ?>&forumpost=<?php echo $row['id']  ?>"><i class="fa fa-flag" title='Report' aria-hidden="true"></i></a></p>
            <hr />
